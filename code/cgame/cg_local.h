...
void CG_PositionEntityOnTagDual(refEntity_t* entity, const refEntity_t* parent, qhandle_t parent_model, const char* tag_name);

void CG_PositionRotatedEntityOnTag(refEntity_t* entity, const refEntity_t* parent, qhandle_t parent_model, const char* tag_name,
