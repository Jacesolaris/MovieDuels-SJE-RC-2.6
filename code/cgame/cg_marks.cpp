...
void CG_ImpactMark(const qhandle_t mark_shader, const vec3_t origin, const vec3_t dir, const float orientation, const float r,
	const float g, const float b, const float a, const qboolean alpha_fade, const float radius, const qboolean temporary)
{
	vec3_t axis[3];
