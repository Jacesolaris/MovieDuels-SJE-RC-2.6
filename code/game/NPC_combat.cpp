...
void ChangeWeapon(const gentity_t* ent, const int newWeapon)
{
...
gentity_t* NPC_CheckEnemy(const qboolean findNew, const qboolean tooFarOk, const qboolean setEnemy)
{
