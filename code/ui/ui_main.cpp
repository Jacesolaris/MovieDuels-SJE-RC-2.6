...
void UI_LoadMenus(const char* menuFile, qboolean reset)
{
	...
	Com_Printf("-----------------------------------------------------------------\n");
	Com_Printf("------------------------Update 6---------------------------------\n");
	Com_Printf("------------------Build Date 16/12/2022--------------------------\n");
	Com_Printf("-----------------------------------------------------------------\n");
	...
	const qboolean goldFlag)
{
	...
	Com_sprintf(itemName, sizeof itemName, "%s_hexpic", powerEnums[forcePowerI].title);
	auto item = Menu_FindItemByName(const_cast<menuDef_t*>(menu), itemName);
	...
	if (item)
	{
		...
		Com_sprintf(itemName, sizeof itemName, "%s_fbutton", powerEnums[forcePowerI].title);
		item = Menu_FindItemByName(const_cast<menuDef_t*>(menu), itemName);
		if (item)
		{
			if (goldFlag)
			{
