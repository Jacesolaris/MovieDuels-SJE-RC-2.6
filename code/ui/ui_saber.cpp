...
void UI_DoSFXSaber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid;
	float radiusmult;
...
void UI_DoEp1Saber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
...
void UI_DoEp2Saber(vec3_t blade_muz, vec3_t blade_dir, float lengthMax, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid, rgb = { 1, 1, 1 };
	float radiusmult;
...
void UI_DoEp3Saber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid, rgb = { 1, 1, 1 };
	float radiusmult;
...
void UI_DoOTSaber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid, rgb = { 1, 1, 1 };
	float radiusmult;
...
void UI_DoRotJSaber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid;
	float radiusmult;
...
void UI_DoTFASaber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid;
	float radiusmult;
...
void UI_DoUnstableSaber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid, rgb = { 1, 1, 1 };
	float radiusmult;
...
void UI_DoSaberUnstable(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid, rgb = { 1, 1, 1 };
	float radiusmult;
...
void UI_DoSaber(vec3_t origin, vec3_t dir, const float length, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid, rgb = { 1, 1, 1 };
	qhandle_t blade, glow;
	refEntity_t saber;
...
void UI_DoRebelsSaber(vec3_t blade_muz, vec3_t blade_dir, const float length_max, const float radius, const saber_colors_t color, const int which_saber)
{
	vec3_t mid, rgb = { 1, 1, 1 };
	float radiusmult;
...
void UI_SaberDrawBlade(itemDef_t* item, const char* saber_name, const int saber_model, const saberType_t saber_type, vec3_t origin, const float cur_yaw, const int blade_num)
{
